...
CMFCkeyboardGameDlg::CMFCkeyboardGameDlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_MFC_KEYBOARDGAME_DIALOG, pParent)
{
	m_hIcon = AfxGetApp()->LoadIcon(IDR_MAINFRAME);
}

void CMFCkeyboardGameDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
}

BEGIN_MESSAGE_MAP(CMFCkeyboardGameDlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
...
// CMFCkeyboardGameDlg 메시지 처리기

BOOL CMFCkeyboardGameDlg::OnInitDialog()
{
...
void CMFCkeyboardGameDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void CMFCkeyboardGameDlg::OnPaint()
{
	if (IsIconic())
	{
...
//  이 함수를 호출합니다.
HCURSOR CMFCkeyboardGameDlg::OnQueryDragIcon()
{
